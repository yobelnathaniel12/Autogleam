        ...
        <div class="py-5">
            <div class="row h-100 align-items-center py-5">
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <img src="image/inova-zenix.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid", style="padding-inline: 5%">
            <div>
                <div class="row text-center d-flex justify-content-center align-items-center mb-5">
                    <div
                        class="my-3 me-4 col-lg-5 order-2 order-lg-1 feature-card d-flex flex-column rounded-4 p-4 text-center shadow">
                        <div
                    ...
                    <div
                        class="my-3 me-4 col-lg-5 order-1 order-lg-2 feature-card d-flex flex-column rounded-4 p-4 text-center shadow">
                        <div
                            class="circle-icon rounded-circle d-flex justify-content-center align-items-center w-70 h-70 mx-auto">
