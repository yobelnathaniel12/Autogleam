<footer style="background-color: #5a4ae2" class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 text-white uppercase dark:text-white">Fitur</h2>
                ...
                <div>
                    <h2 class="mb-6 font-semibold text-gray-900 uppercase text-white dark:text-white">Perusahaan</h2>
                ...
                <div>
                    <h2 class="mb-6 font-semibold text-gray-900 uppercase text-white dark:text-white">Terhubung dengan kami
                    </h2>
                    <ul class="text-gray-200 text-sm dark:text-gray-400 font-medium">
                        <li class="mb-2">
        ...
        <div class="sm:flex sm:items-center text-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center text-center dark:text-gray-400 text-white mx-auto">
